...
TEST_CASE("decompress-single-file") {
  REQUIRE(std::filesystem::exists("LICENSE.tar.gz"));
  REQUIRE(sha3_512_file("LICENSE.tar.gz") ==
  ...
  REQUIRE(std::filesystem::exists("LICENSE"));
  REQUIRE(sha3_512_file("LICENSE") ==
...
TEST_CASE("decompress-multiple-files") {
  REQUIRE(std::filesystem::exists("zlib-v1.2.11.tar.gz"));
  REQUIRE(sha3_512_file("zlib-v1.2.11.tar.gz") ==
  ...
  REQUIRE(name == "madler-zlib-7085a61");
