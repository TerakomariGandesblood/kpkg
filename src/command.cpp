...
std::string calc_command(const std::vector<std::string>& commands,
  ...
  cmd = combine_command(
      cmd,
      R"(export CFLAGS="-march=x86-64 -mtune=generic -g0 -O3 -fPIC -static-libgcc" && export CXXFLAGS="-march=x86-64 -mtune=generic -g0 -O3 -fPIC -static-libgcc -static-libstdc++")");
