...
std::string calc_command(const std::vector<std::string>& commands,
  ...
  cmd = combine_command(
      cmd,
      R"(export CFLAGS="-mtune=generic -march=x86-64 -g0 -O3 -fPIC -static-libgcc" && export CXXFLAGS="-mtune=generic -march=x86-64 -g0 -O3 -fPIC -static-libgcc -static-libstdc++")");
